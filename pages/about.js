    ...
    <div>
      ...
      >
        ...
        <p className="text-lg md:text-xl lg:text-xl">
          Kruss Automotive Services began with a vision to provide professional
          auto services to busy clients who value convenience and quality. In a
          world where time is precious, we understand the importance of reliable
          and trustworthy automotive solutions.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-xl">
            ...
            continuous improvement. We aspire to establish enduring partnerships
            with our customers, becoming their trusted automotive ally.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className="text-lg md:text-xl lg:text-xl">
          Excellence - Pioneering excellence in every facet of our work, aiming
          for supreme service quality and exceeding customer expectations.
        </p>
        <p className="text-lg md:text-xl lg:text-xl">
      ...
      <div
        className=" p-6 mt-9 mb-7 text-center"
        data-aos="fade-down"
        data-aos-delay="400"
      >
